<template>
    <div class="utisak-o-proizvodu">
        ...
        <!-- <el-form> -->
            ...
            <div class="dugme">
                <el-button @click="potvrdiUnos()" type="success" round style="border-color:rgba(213, 34, 92, 0.925); background-color:rgba(213, 34, 92, 0.925);">Sačuvaj</el-button>
                <!-- <el-button @click="ponisti" type="danger" round style="color:rgba(213, 34, 92, 0.925); background-color: white; border-color:white">Poništi</el-button> -->
            </div>
        <!-- </el-form> -->
        </el-dialog>
    </div>
