    ...
    <div class="dodaj-proizvod-container">
        <el-dialog visible width="28%" heigth="30%" @close="$emit('zatvoriDodavanjeProizvoda')" :modal-append-to-body="false">
            <el-form>
                ...
                <div class="dugme">
                    <el-button round size="mini" @click="addProduct()" style="color:white; margin-right:5px; border-color:rgba(213, 34, 92, 0.925); background-color:rgba(213, 34, 92, 0.925);">Dodaj proizvod</el-button>
                </div>
            </el-form>
        </el-dialog>
    </div>
