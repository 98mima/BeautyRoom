        ...
        <el-dialog visible width="30%" @close="$emit('closeSignupForm')">
            <div class="forma">
                <el-form>
                    ...
                    <div class="dugme">
                        <el-button @click="onSignUpClick()" round style="margin-right:5px; color: white; background-color: rgba(213, 34, 92, 0.925); border-color:rgba(213, 34, 92, 0.925);">Registruj se</el-button>
                    </div>
                </el-form>
            </div>
        </el-dialog>
