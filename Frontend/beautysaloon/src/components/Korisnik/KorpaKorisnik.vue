<template>
    <div class="korpa-container">
        <div class="korpa-tabela">
            ...
            <el-button round :disabled="cartItems.length == 0 ? true : false" style="margin-top: 10px; background-color: rgba(213, 34, 92, 0.925); border-color:rgba(213, 34, 92, 0.925);" @click="Naruci()" type="primary">Naruči</el-button>
        </div>
    </div>
</template>
...
<style scoped>
    .korpa-container{
            ...
            align-items: center;
            overflow: auto;
            background-color: rgba(249, 227, 254, 0.445);  
    }
    .korpa-tabela{
        display: flex;
        padding: 5px;
